...
(async () => {
  ...
  console.log(`snapshot-worker: poly=${result.poly_count}  coinbase=${result.coinbase_count}  candles=${result.candle_count}  warehouse=${result.warehouse_mirrored}${sbStr}  in ${result.latency_ms}ms`);
